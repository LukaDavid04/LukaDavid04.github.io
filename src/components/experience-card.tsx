...
export function ExperienceCard({
  ...
  return (
    <>
      ...
      >
        <Card className="h-full transition-all duration-300 ease-out group-hover:-translate-y-0.5 group-hover:shadow-[0_3px_12px_rgba(99,102,241,0.14)] group-focus-visible:-translate-y-0.5 group-focus-visible:shadow-[0_3px_12px_rgba(99,102,241,0.14)]">
          <CardHeader>
          ...
          <CardContent className="space-y-3">
            ...
            <ul className="space-y-2 text-sm list-disc pl-5">
              {exp.highlights.slice(0, highlightLimit).map((h) => (
                <li key={h}>{h}</li>
              ))}
            </ul>
